import { EFFECT_STATS } from "../stats";
...
export const PHASE1_EVENTS = Object.freeze({
  ...
  EV_P1_ELIAS_TALK: {
    ...
    Telephone: {
      ...
      choices: [
        { text: "Cha sẽ về sớm.", effect: { [E.HAPPINESS]: 5 } },
        { text: "Cha còn nhiều việc phải làm.", effect: { [E.HAPPINESS]: -5 } }
      ]
    }
  },
  ...
  //         effect: { [E.ECONOMY]: 20, [E.HAPPINESS]: -15 },
  //       },
  //       {
  //         text: "Hệ thống đang quá tải, cần thêm thời gian.",
  //         effect: { [E.ECONOMY]: -10, [E.HAPPINESS]: 5 },
  //       }
  //     ]
  //   }
  // },
  ...
  //         effect: { [E.COAL]: -25000, [E.HAPPINESS]: 10 },
  //       },
  //       {
  //         text: "Tôi không có thẩm quyền.",
  //         effect: { [E.COAL]: 0, [E.HAPPINESS]: -20, [E.RESOURCE]: -100 },
  ...
  //         effect: { [E.ECONOMY]: -50000, [E.HAPPINESS]: 15 },
  //       },
  //       {
  //         text: "Thi hành lệnh cắt giảm.",
  //         effect: { [E.ECONOMY]: 30, [E.HAPPINESS]: -20, [E.RESOURCE]: -50 },
  ...
  //         effect: { [E.ECONOMY]: -40000, [E.HAPPINESS]: 20 },
  //       },
  //       {
  //         text: "Bác bỏ, chờ đến kỳ kiểm tra định kỳ.",
  //         effect: { [E.ECONOMY]: 0, [E.HAPPINESS]: -20, [E.RESOURCE]: -30 },
  //       }
  //     ]
  //   }
  // },
  ...
  //         effect: { [E.ECONOMY]: -85000, [E.HAPPINESS]: 25 },
  //       },
  //       {
  //         text: "Tôi không quan tâm, đây là yêu cầu từ thượng tầng.",
  //         effect: { [E.ECONOMY]: 0, [E.HAPPINESS]: -25, [E.RESOURCE]: -40 },
  //       }
  //     ]
  //   }
  // },
  ...
  //       normalImg: MAIL.MAIL_1.NORMAL,
  //       hoverImg: MAIL.MAIL_1.HOVER,
  //       choices: [
  //         {
  //           text: "* Đã đọc *",
