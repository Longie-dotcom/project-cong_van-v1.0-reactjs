...
export const PAPER_CONFIG = Object.freeze({
  ...
  UPGRADES: {
    ...
    D: [
      ...
      { id: "submit_cartel", name: "Nộp Hoàn Thành Chỉ Tiêu", level: 1, baseCost: 0, metric: "Chỉ tiêu", value: "Uy tín sếp", description: "Giao nộp Than cho Cartel...", asset: PaperIcon }
    ]
  },

  // Cấu hình UI (Gộp từ PAPER)
  UI: {
    background: PaperBackground,
    tabs: {
      A: { title: "Kế Hoạch Mở Rộng Nhân Lực", normal: TabI1, hover: TabI2 },
      B: { title: "Cải Tiến Giá Trị Của Than", normal: TabII1, hover: TabII2 },
      C: { title: "Hệ Thống Thu Thập Tự Động", normal: TabIII1, hover: TabIII2 },
      D: { title: "Quyết Định Của Quản Đốc", normal: TabIV1, hover: TabIV2 },
    }
  },

  // Cấu hình âm thanh (Gộp từ PAPER_SOUNDS)
  SOUNDS: {
    confirmation: [ConfirmationSound1, ConfirmationSound2, ConfirmationSound3, ConfirmationSound4],
    error: ErrorSound,
