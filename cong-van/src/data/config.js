export const GAME_BALANCE = {
  ...
  MINE_CLICK: {
    ...
    MULTIPLIER: 0.321,    // Hệ số nhân với RESOURCE (nhân lực), Ví dụ: MULTIPLIER = 0.1 thì tức là 10 nhân lực sẽ cho ra 1 than cho mỗi click, note: Đã làm tròn trong công thức
  },
