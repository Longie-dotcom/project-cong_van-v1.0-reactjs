  ...
  return (
    ...
    >
      <img 
        src={currentImg} 
        alt={altText} 
        style={{ display: 'block', width: '22px', height: 'auto', imageRendering: 'pixelated' }} 
      />
    </button>
  );
}
...
export default function Telephone({ phoneCalls = [], onCallDialed }) {
  ...
  const ringFrames = [TelephoneNormal, TelephoneRing1, TelephoneRing2, TelephoneRing3];

  const numericButtonsConfig = [
    { value: '1', normal: Button1Normal, hover: Button1Hovered, click: Button1Clicked },
    { value: '2', normal: Button2Normal, hover: Button2Hovered, click: Button2Clicked },
    { value: '3', normal: Button3Normal, hover: Button3Hovered, click: Button3Clicked },
    { value: '4', normal: Button4Normal, hover: Button4Hovered, click: Button4Clicked },
    { value: '5', normal: Button5Normal, hover: Button5Hovered, click: Button5Clicked },
    { value: '6', normal: Button6Normal, hover: Button6Hovered, click: Button6Clicked },
    { value: '7', normal: Button7Normal, hover: Button7Hovered, click: Button7Clicked },
    { value: '8', normal: Button8Normal, hover: Button8Hovered, click: Button8Clicked },
    { value: '9', normal: Button9Normal, hover: Button9Hovered, click: Button9Clicked },
  ];
  ...
  const playKeypadSound = () => {
    if (keypadPoolRef.current.length > 0) {
      ...
      keypadIndexRef.current = (keypadIndexRef.current + 1) % keypadPoolRef.current.length;
    }
  };
  ...
  }, [isOpen, currentCallIdx, currentLineIdx, currentLineText, currentSpeakerBlip]);
  ...
  return (
    <div className="telephone-system-wrapper">
      ...
      <div className="telephone-led-display">
        <span className="dialed-number-text">
          {dialedNumber || ""}
        </span>
      </div>
      ...
      <div className="telephone-component-container">
        <img 
          src={phoneState === 'ringing' ? ringFrames[ringFrame] : TelephoneNormal} 
          alt="Telephone Base" 
        ...
        >
          ...
          <div className="caller-speech-bubble">
            <p className="caller-text-content">
              <span className='caller-identity-tag'>{currentSpeakerName}:</span> {displayedText}
            </p>
          </div>
        </div>
      )}
